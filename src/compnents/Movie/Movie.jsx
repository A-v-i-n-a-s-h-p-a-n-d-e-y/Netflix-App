...
const Home = () => {
    ...
    useEffect(()=>{
         ...
         const fetchTopRated = async () => {
            const {
                data: { results },
            } = await axios.get("https://api.themoviedb.org/3/movie/top_rated?api_key=212ab98f341749873718e03cc2f206a7&language=en-US&page=1");
    ...
    return (
        <section className='home'>
            ...
            <Row title={"GetPopular"} arr={getpopularMovies}/>
